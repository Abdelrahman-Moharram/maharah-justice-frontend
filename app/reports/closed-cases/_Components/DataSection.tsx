...
const DataSection = () => {
  ...
  return (
    <div>
      <Filter 
        excel={()=>exportData({ExportFun:ExportData, fileName:'القضايا', params:{...params, type:'excel'}, type:'excel'})}
        pdf={()=>exportData({ExportFun:ExportData, fileName:'القضايا', params:{...params, type:'pdf'}, type:'pdf'})}
