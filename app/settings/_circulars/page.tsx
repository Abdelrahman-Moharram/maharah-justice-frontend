...
import CircularFormModal from './_Components/CircularFormModal'
import CircularsList from './_Components/CircularsList'
...
const BreadcrumbData = [
  ...
  {
    href: '/settings/circulars',
    title: 'إعدادات الدائرات',
    current:true
  }
]
