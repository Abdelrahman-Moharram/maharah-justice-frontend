...
const Message = ({message}:{message:MessageType}) => {
  return (
    <div
        className={`block my-2 drop-shadow-sm p-4 shadow-lg bg-container focus:outline-none focus:ring ${message.is_by_me?'rounded-l-xl rounded-tr-xl ':'rounded-tl-xl rounded-r-xl'}`}
    >
