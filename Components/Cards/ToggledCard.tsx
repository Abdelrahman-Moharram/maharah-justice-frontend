...
const ToggledCard = ({title, children, className}:Props) => {
  ...
  return (
    <div key={title+show} className={className + ' bg-container w-full relative z-0 py-3 px-4 mb-4 rounded-lg drop-shadow-lg transition-all delay-150 '+(show?'h-fit':'max-h-[50px]')} >
